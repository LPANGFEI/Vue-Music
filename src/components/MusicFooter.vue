<template>
    <section class="footer">
        <section class="container">
            ...
            <mt-button class="openapp" plain type="danger" size="large">打开APP，发现更多好音乐 ></mt-button>
            <p class="text">个人学习项目 网易公司版权所有</p>
        </section>
    </section>
</template>
...
.footer {
    ...
    height: 8.5rem;
    text-align: center;
    background: url("https://s3.music.126.net/m/s/img/recommand_bg_2x.png?d045fafc60e017b653f8065a87496922");
}
.container {
    .logo {
        padding-top: 12%;
